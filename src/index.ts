...
function main() {
  pokemonService.addPokemon(DEFAULT_POKEMONS.mewtwo);
  pokemonService.addPokemon(DEFAULT_POKEMONS.dragonite);
  pokemonService.addPokemon(DEFAULT_POKEMONS.pikachu);
